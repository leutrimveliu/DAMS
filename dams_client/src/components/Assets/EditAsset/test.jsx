...
function EditAsset() {
    ...
    const getAssetFields = async () => {
      ...
      setAssetDetails((oldDetails) => ({
        ...
        assetOldNr: response.assetOldNr,
        ...
        <div className="d-flex justify-content-center mb-5 mt-5">
          ...
          >
            <Row>
              ...
              <Form.Group  controlId="assetNr" >
                  <Form.Label>Asset No.</Form.Label>
                <Form.Control
                    name="assetNr"
                    type="text"
                    onChange={handleChange}
                    defaultValue={assetDetails.assetNr}
                  ...
                  <p style={{ color: "red" }}>
                    &#8203;
                    {errors.assetNr &&
                      errors.assetNr.type === "required" && (
                        <span>This field is required!</span>
                      )}
                  </p>
                </Form.Group>
                <Form.Group controlId="assetOldNr">
                  <Form.Label>Asset Old No.</Form.Label>
                  <Form.Control
                    name="assetOldNr"
                    type="text"
                    onChange={handleChange}
                    defaultValue={assetDetails.assetOldNr}
                    placeholder="Asset Old Number..."
                    ref={register({ required: true })}
                  />
                  <p style={{ color: "red" }}>
                    &#8203;
                    {errors.assetOldNr &&
                      errors.assetOldNr.type === "required" && (
                        <span>This field is required!</span>
                      )}
                  </p>
                </Form.Group>
